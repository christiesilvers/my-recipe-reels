...
export default function Footer() {
  return (
    <footer className="mt-1 md:mt-0 px-5 md:px-12 xl:px-24 pb-1 md:pb-4 text-center text-[11px] md:text-xs" style={{ color: 'rgba(255,255,255,0.25)' }}>
      <div className="border-t pt-1 md:pt-3" style={{ borderColor: 'rgba(255,255,255,0.07)' }}>
