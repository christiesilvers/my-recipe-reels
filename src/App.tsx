...
function ReelModal({ reel, onClose, onHide, onPrev, onNext, saved, onToggleSave }: {
  ...
  return (
    ...
    >
      <div
        className="relative w-full max-w-sm rounded-2xl overflow-hidden shadow-2xl flex flex-col h-[98vh] md:h-[85vh]"
      ...
      >
        ...
        <div className="px-4 pt-2 pb-2 space-y-1.5 overflow-y-auto flex-shrink-0 max-h-[50vh]">
          <div>
